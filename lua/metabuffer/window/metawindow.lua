...
M.statusline = "%%#MetaStatuslineMode%s# %s%%#MetaStatuslineIndicator# %d/%d%s%%#MetaStatuslineMiddle#%%=%%#MetaStatuslineMatcher%s# %s %%#MetaStatuslineKey#%s%%#MetaStatuslineCase%s# %s %%#MetaStatuslineKey#%s%%#MetaStatuslineSyntax%s# %s %%#MetaStatuslineKey#%s "
...
M.new = function(nvim, win)
  ...
  self["set-statusline-state"] = function(mode_group, mode_label, name, num_hits, num_lines, line_nr, debug_out, matcher, case_mode, hl_prefix, syntax)
    local matcher_suffix = title_case(matcher)
    local case_suffix = title_case(case_mode)
    local text = string.format(M.statusline, mode_group, mode_label, num_hits, num_lines, (debug_out or ""), matcher_suffix, matcher, "C^", case_suffix, case_mode, "C-o", hl_prefix, syntax, "Cs")
