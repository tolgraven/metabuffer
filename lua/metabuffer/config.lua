...
M["apply-router-defaults"] = function(router, vim)
  ...
  local default_prompt_fallback_keymaps = {{"i", "<C-a>", "prompt-home"}, {"i", "<C-e>", "prompt-end"}, {"i", "<C-u>", "prompt-kill-backward"}, {"i", "<C-k>", "prompt-kill-forward"}, {"i", "<C-y>", "prompt-yank"}}
  ...
  router["prompt-text-sync-interval-ms"] = (vim.g.meta_prompt_text_sync_interval_ms or 25)
