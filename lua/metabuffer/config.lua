...
local default_main_keymaps = {{"n", "!", "exclude-symbol-under-cursor"}, {"n", "<CR>", "accept-main"}, {"n", "<LocalLeader>i", "toggle-info-file-entry-view"}, {"n", "<ScrollWheelDown>", "scroll-main", "line-down"}, {"n", "<ScrollWheelUp>", "scroll-main", "line-up"}, {"n", "<M-CR>", "insert-symbol-under-cursor"}, {"n", "<A-CR>", "insert-symbol-under-cursor"}}
