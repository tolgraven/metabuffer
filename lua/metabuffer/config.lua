...
local default_main_keymaps = {{"n", "!", "exclude-symbol-under-cursor"}, {"n", "#", "insert-symbol-under-cursor-newline"}, {"n", "<CR>", "accept-main"}, {"n", "<LocalLeader>i", "toggle-info-file-entry-view"}, {"n", "<ScrollWheelDown>", "scroll-main", "line-down"}, {"n", "<ScrollWheelUp>", "scroll-main", "line-up"}, {{"n", "i"}, "<M-CR>", "toggle-prompt-results-focus"}, {{"n", "i"}, "<A-CR>", "toggle-prompt-results-focus"}}
...
M.defaults = {options = {history_max = 100, project_max_file_bytes = (1024 * 1024), project_max_total_lines = 500000, project_rg_bin = "rg", project_rg_base_args = {"--files", "--glob", "!.git"}, project_rg_include_ignored_args = {"--no-ignore", "--no-ignore-vcs", "--no-ignore-parent"}, project_rg_deps_exclude_globs = {"!node_modules/**", "!vendor/**", "!deps/**", "!.venv/**", "!venv/**", "!dist/**", "!build/**", "!target/**"}, project_fallback_glob_pattern = "**/*", info_max_lines = 10000, info_min_width = 28, info_max_width = 52, context_height = 14, context_around_lines = 3, context_max_blocks = 24, info_file_entry_view = "meta", prompt_update_debounce_ms = 170, prompt_update_idle_ms = 90, prompt_short_query_extra_ms = {180, 120, 70}, prompt_size_scale_thresholds = {2000, 10000, 50000}, prompt_size_scale_extra = {0, 2, 6, 10}, project_lazy_enabled = true, project_lazy_disable_headless = true, project_lazy_min_estimated_lines = 5000, project_lazy_chunk_size = 4, project_lazy_frame_budget_ms = 6, project_lazy_refresh_debounce_ms = 32, project_lazy_refresh_min_ms = 8, project_lazy_prefilter_enabled = true, project_source_syntax_chunk_lines = 240, project_bootstrap_delay_ms = 120, project_bootstrap_idle_delay_ms = 140, prompt_forced_coalesce_ms = 700, preview_source_switch_debounce_ms = 60, source_syntax_refresh_debounce_ms = 80, scroll_sync_debounce_ms = 20, ui_animations_enabled = true, ui_animations_time_scale = 1.5, ui_animation_prompt_enabled = true, ui_animation_prompt_ms = 140, ui_animation_prompt_time_scale = 1, ui_animation_prompt_backend = "native", ui_animation_preview_enabled = true, ui_animation_preview_ms = 180, ui_animation_preview_time_scale = 1, ui_animation_info_enabled = true, ui_animation_info_ms = 220, ui_animation_info_time_scale = 1, ui_animation_info_backend = "native", ui_animation_loading_enabled = true, ui_animation_loading_ms = 90, ui_animation_loading_time_scale = 1, ui_loading_indicator = true, ui_animation_scroll_enabled = true, ui_animation_scroll_ms = 140, ui_animation_scroll_time_scale = 1, ui_animation_scroll_backend = "native", window_local_layout = true, dep_dir_names = {node_modules = true, [".venv"] = true, venv = true, vendor = true, deps = true, dist = true, build = true, target = true, __pycache__ = true, [".mypy_cache"] = true, [".pytest_cache"] = true, [".tox"] = true, [".next"] = true, [".nuxt"] = true, [".yarn"] = true, [".pnpm-store"] = true}, default_include_binary = false, default_include_deps = false, default_include_files = false, default_include_hex = false, default_include_hidden = false, default_include_ignored = false}, ui = {custom_mappings = {}, highlight_groups = {All = "Title", Fuzzy = "Number", Regex = "Special"}, syntax_on_init = "buffer", prefix = "#"}, keymaps = {prompt = default_prompt_keymaps, main = default_main_keymaps, prompt_fallback = default_prompt_fallback_keymaps}}
