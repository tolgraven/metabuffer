...
package.preload["metabuffer.nfnl.fennel.repl"] = package.preload["metabuffer.nfnl.fennel.repl"] or function(...)
  local _759_ = require("metabuffer.nfnl.fennel.utils")
  local utils = _759_
  local copy = _759_["copy"]
  local parser = require("metabuffer.nfnl.fennel.parser")
  local compiler = require("metabuffer.nfnl.fennel.compiler")
  local specials = require("metabuffer.nfnl.fennel.specials")
  local view = require("metabuffer.nfnl.fennel.view")
  local depth = 0
...
package.preload["metabuffer.nfnl.fennel.specials"] = package.preload["metabuffer.nfnl.fennel.specials"] or function(...)
  local _529_ = require("metabuffer.nfnl.fennel.utils")
  local utils = _529_
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "metabuffer.nfnl.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["metabuffer.nfnl.fennel.compiler"] = package.preload["metabuffer.nfnl.fennel.compiler"] or function(...)
  local _299_ = require("metabuffer.nfnl.fennel.utils")
  local utils = _299_
  local unpack = _299_["unpack"]
  local parser = require("metabuffer.nfnl.fennel.parser")
  local friend = require("metabuffer.nfnl.fennel.friend")
  local view = require("metabuffer.nfnl.fennel.view")
...
package.preload["metabuffer.nfnl.fennel.friend"] = package.preload["metabuffer.nfnl.fennel.friend"] or function(...)
  local _195_ = require("metabuffer.nfnl.fennel.utils")
  local utils = _195_
...
package.preload["metabuffer.nfnl.fennel.parser"] = package.preload["metabuffer.nfnl.fennel.parser"] or function(...)
  local _194_ = require("metabuffer.nfnl.fennel.utils")
  local utils = _194_
...
local utils = nil
package.preload["metabuffer.nfnl.fennel.view"] = package.preload["metabuffer.nfnl.fennel.view"] or function(...)
...
package.preload["metabuffer.nfnl.fennel.utils"] = package.preload["metabuffer.nfnl.fennel.utils"] or function(...)
  local view = require("metabuffer.nfnl.fennel.view")
  local version = "1.6.0"
...
utils = require("metabuffer.nfnl.fennel.utils")
local parser = require("metabuffer.nfnl.fennel.parser")
local compiler = require("metabuffer.nfnl.fennel.compiler")
local specials = require("metabuffer.nfnl.fennel.specials")
local repl = require("metabuffer.nfnl.fennel.repl")
local view = require("metabuffer.nfnl.fennel.view")
