...
local _local_1_ = require("metabuffer.nfnl.module")
local autoload = _local_1_.autoload
local define = _local_1_.define
local core = autoload("metabuffer.nfnl.core")
local str = autoload("metabuffer.nfnl.string")
local fs = autoload("metabuffer.nfnl.fs")
local nvim = autoload("metabuffer.nfnl.nvim")
local compile = autoload("metabuffer.nfnl.compile")
local config = autoload("metabuffer.nfnl.config")
local api = autoload("metabuffer.nfnl.api")
local notify = autoload("metabuffer.nfnl.notify")
local vim = _G.vim
local M = define("metabuffer.nfnl.callback")
