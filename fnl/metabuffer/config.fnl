...
(local default-prompt-keymaps
  [ [["n" "i"] "<CR>" "accept"]
    [["n" "i"] "<M-CR>" "enter-edit-mode"]
    [["n" "i"] "<A-CR>" "enter-edit-mode"]
    ["n" "<Esc>" "cancel"]
