      ...
      (let [ref (and src-idx (. refs src-idx))]
        (table.insert rows
          {:src-idx src-idx
           ...
           :source-lnum (and ref ref.source-lnum)
           :source-text (and ref ref.source-text)
           :source-group-id (and ref ref.source-group-id)
           :source-group-kind (and ref ref.source-group-kind)
           :transform-chain (vim.deepcopy (or (and ref ref.transform-chain) []))
