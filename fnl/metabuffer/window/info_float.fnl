...
(fn close-window!
  ...
  (set session.info-animated? nil)
  (set session.info-config-sig nil)
  (set session.info-render-sig nil)
  (set session.info-post-fade-refresh? nil)
  (set session.info-render-suspended? nil)
  (set session.info-start-index nil)
  (set session.info-stop-index nil)
  (set session.info-render-start nil)
  (set session.info-render-stop nil)
  (set session.info-last-selected-index nil)
  (set session.info-last-project-loading? nil)
